...
from myapp.models import Payment as PaymentModel
import logging
...
def check_payment_status(self, internal_payment_id):
    try:
        ...
        local_payment = PaymentModel.objects.get(id=internal_payment_id)
        ...
        yk_payment = Payment.find_one(local_payment.provider_payment_id)
